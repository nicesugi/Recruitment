...
class UserLog(models.Model):
    ...
    log_date = models.DateField("최근 로그인", null=True)
    last_application = models.DateField("마지막 지원일자", null=True)
